(function() {
  ...
  _.last = function(array, n) {
    var numElements = n > array.length ? array.length : n;
    return n === undefined ? array[array.length - 1] : array.slice(array.length - numElements, array.length)
  };
